...
### Funciones en src/services/ai.js (y gemini.js para Gemini directo)
...
- `generateTestCases({ huName, huDescription, ambiente, useContext?, previousReport?, adjustment? })` — cuando `useContext=true`: `appContext` + `skill_tc_qa.md` + `testCaseTemplate.systemPromptFromHU`; genera 4–10 TCs; soporta ajuste iterativo
